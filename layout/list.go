...
//
// (lmc, note to self: I think this is actually core Gio, now. I have a
// different version, above. I should probably put this one back in and rename
// mine to "MakeVisible" or something.)
